...
#--------------------------------------------------------------
  ...
  setup_data    <- reactive({ dataReady_setup(imprt_data())        })
  rating_data   <- reactive({ dataReady_rating(imprt_data())       })
  item_data     <- reactive({ dataReady_itemdata(imprt_data())     })
  examinee_data <- reactive({ dataReady_examineedata(imprt_data()) })
#
